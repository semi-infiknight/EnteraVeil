  ...
  return (
    <>
      ...
      <div className="pointer-events-none fixed inset-x-0 z-40 flex justify-center px-4 large:hidden bottom-[calc(56px+max(env(safe-area-inset-bottom),0px))]">
        {/* Anti-Claude: replaces rounded-full pill bar with a sharp-rect
            6px container. */}
        <div className="pointer-events-auto flex w-full max-w-[600px] items-center gap-3 rounded-md border border-ev-gold/40 bg-primary/95 px-3 py-2 shadow-[0_18px_40px_-12px_rgba(0,0,0,0.7)] backdrop-blur">
