  ...
  <section className="relative h-[78vh] min-h-[520px] w-full overflow-hidden bg-primary small:h-[88vh] small:min-h-[680px] 2xl:h-[92vh]">
    ...
    <Box className="absolute inset-x-0 bottom-0 px-6 pb-10 small:px-14 small:pb-16 2xl:px-24 2xl:pb-20">
      <Box className="mx-auto max-w-[1328px]">
        <span className="ev-rise ev-eyebrow text-action-primary">
          Anime streetwear · beyond the veil
        </span>
        <Heading className="ev-rise ev-rise-delay-1 ev-display mt-4 max-w-[14ch] text-5xl text-static small:text-7xl medium:text-8xl 2xl:text-9xl">
          New drop.
          <br />
        ...
        <Text
          size="lg"
          className="ev-rise ev-rise-delay-2 mt-5 max-w-[440px] text-static/80 small:max-w-[520px]"
        >
          Hand-printed tees, heavyweight sweats and otherworldly graphics —
          small-batch from a tiny crew in Bangalore.
        </Text>
        <Box className="ev-rise ev-rise-delay-3 mt-7 flex flex-wrap items-center gap-3">
          <Button
            asChild
